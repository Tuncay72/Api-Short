...
public class LibraryAPP_API_DB_Test {
    ...
    public void test(){
        ...
        // We will make a call to /Dashboard_stats endpoint
        // and validate the data against database data
        
        DB_Utility.runQuery("SELECT count(*) from books");
        //it return the book count as single raw and column
    ...
    public static void destroy(){
        ...
        DB_Utility.destroy();
        RestAssured.reset(); // this is for resetting all the values
                            // we set for RestAssured itself
