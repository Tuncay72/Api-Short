...
//        Spartan2 sp = new Spartan2(261,"Elma","Male",9999999998L)
    ...
    public void gettingNestedJsonAsPojo() {                                  
        ...
        System.out.println("response.path(\"id\") = " + response.path("content[0].id"));
        ...
        System.out.println("First Gender: " + jp.getString("content[0].gender"));
        System.out.println("First phoneNumber: " + jp.getString("content[0].phone"));
