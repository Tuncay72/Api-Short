...
public class HR_ORDS_GroovyMagic {
    ...
    public void testEmployees(){
        ...
        //get all last names from 10-15
        System.out.println("last name from 10-15: "+ jp.getList("items[10..15].last_name"));

//        //get all last names from 10-15 uppercase
//        System.out.println("last name from 10-15: "
//                + jp.getList("items[10..15].last_name.toUpperCase()"));

        //get all employee first_name with employee id of 105
        ...
        String result2 = jp.getString("items.find{ it.employee_id == 105 }.last_name ");
